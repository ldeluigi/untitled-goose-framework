...
class OperationTest extends AnyFlatSpec with Matchers {
  ...
  val gameEvent: GameEvent = StopOnTileEvent(gameMutableState.currentPlayer, gameMutableState.gameBoard.tileOrdering.first, gameMutableState.currentTurn, gameMutableState.currentCycle)
